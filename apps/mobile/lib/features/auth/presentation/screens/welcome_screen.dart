...
import 'package:canopy/features/auth/presentation/widgets/canopy_logo.dart';
        ...
        Flexible(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                const CanopyLogo(iconSize: 28, fontSize: 18, darkText: false),
                ConstrainedBox(
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          // Mobile-only logo
          if (isMobile) ...[
            const Center(child: CanopyLogo(iconSize: 36, fontSize: 18)),
