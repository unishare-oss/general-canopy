...
void main() {
  ...
  group('ThemeNotifier', () {
    test('initial state defaults to canopy when box is empty', () {
      final container = ProviderContainer();
      addTearDown(container.dispose);
      expect(container.read(themeProvider), 'canopy');
    });
  ...
  group('activeThemeProvider', () {
    test('returns ThemeData for selected theme', () async {
      ...
      expect(brightness, Brightness.light); // canopy default is light
    });
  });
}
