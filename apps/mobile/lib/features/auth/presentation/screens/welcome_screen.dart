...
class _AuthScreenState extends ConsumerState<AuthScreen> {
  ...
  Future<void> _handleSignUp() async {
    setState(() { _serverError = null; _consentError = !_consentChecked; });
    if (!(_formKey.currentState?.validate() ?? false)) return;
            ...
            child: SafeArea(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.park_rounded, size: 72, color: cs.onPrimary.withValues(alpha: 0.9)),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                _Tab(label: 'Sign in', selected: !isSignUp, onTap: () { if (isSignUp) _switchMode(); }),
                _Tab(label: 'Create account', selected: isSignUp, onTap: () { if (!isSignUp) _switchMode(); }),
              ],
            ),
          ),
          const SizedBox(height: 20),
          ...
          // Google
          GoogleSignInButton(onPressed: _handleGoogleSignIn, isLoading: _googleLoading),
          ...
          Row(children: [
            ...
            Padding(
              ...
              child: Text('or', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: ac.mutedForeground)),
            ),
            Expanded(child: Divider(color: cs.outlineVariant)),
          ]),
          const SizedBox(height: 16),
          ...
          if (isSignUp) ...[
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Checkbox(
                ...
                onChanged: (v) => setState(() { _consentChecked = v ?? false; if (_consentChecked) _consentError = false; }),
              ...
              Expanded(child: Text('I agree to the Terms of Service and Privacy Policy.',
                style: Theme.of(context).textTheme.bodySmall?.copyWith(color: ac.textSecondary))),
            ]),
            if (_consentError) ...[
              const SizedBox(height: 4),
              Text('You must accept the Terms to create an account',
          ...
          if (_serverError != null) ...[
            ...
            Text(_serverError!, style: Theme.of(context).textTheme.bodySmall?.copyWith(color: cs.error)),
          ],

          const SizedBox(height: 16),
          FilledButton(
            onPressed: (isSignUp && !_consentChecked) || _isLoading ? null
            ...
            child: Text(
              _isLoading ? 'Please wait…' : (isSignUp ? 'Create account' : 'Sign in'),
              style: Theme.of(context).textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.w600, color: cs.onPrimary),
            ),
          ),
          ...
          Center(
            child: TextButton(
              ...
              child: Text('Browse as guest', style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: ac.mutedForeground)),
            ),
          ),
          const SizedBox(height: 8),
        ],
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: selected ? [BoxShadow(color: Colors.black.withValues(alpha: 0.08), blurRadius: 4, offset: const Offset(0, 1))] : null,
          ),
          child: Text(
            label,
            textAlign: TextAlign.center,
